            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="relative glass-card p-6 rounded-2xl border border-slate-200 shadow-xl space-y-5 bg-white">
                ...
                <div className="flex items-center justify-between pb-3.5 border-b border-slate-100">
                  ...
                  <span className="text-[11px] px-2.5 py-0.5 rounded bg-emerald-50 text-[#059669] font-bold border border-emerald-200">
                    Comerc Energia
                  </span>
                </div>
                ...
                <div className="space-y-2.5">
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="font-extrabold text-[#059669] text-base sm:text-lg">
